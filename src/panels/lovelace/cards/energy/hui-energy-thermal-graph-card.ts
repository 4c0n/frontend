...
import type { EnergyThermalGraphCardConfig } from "../types";
import { hasConfigChanged } from "../../common/has-changed";
import { getCommonOptions } from "./common/energy-chart-options";
import type { HaECOption } from "../../../../resources/echarts/echarts";
import { generateEnergyThermalGraphData } from "./energy-thermal-graph-data";
import "./common/hui-energy-graph-chip";
import "../../../../components/ha-tooltip";

@customElement("hui-energy-thermal-graph-card")
export class HuiEnergyThermalGraphCard
  ...
  implements LovelaceCard
{
  ...
  @state() private _config?: EnergyThermalGraphCardConfig;

  public static getStubConfig(
    _hass: HomeAssistant,
    _entities: string[],
    _entitiesFill: string[]
  ): EnergyThermalGraphCardConfig {
    return {
  ...
  public setConfig(config: EnergyThermalGraphCardConfig): void {
  ...
  private async _getStatistics(energyData: EnergyData): Promise<void> {
    const result = generateEnergyThermalGraphData({
      hass: this.hass,
      energyData,
...
declare global {
  interface HTMLElementTagNameMap {
    "hui-energy-thermal-graph-card": HuiEnergyThermalGraphCard;
  }
}
